#8) El siguiente programa implementa una animación de una pelotita rebotando por 
#la pantalla. Modifíquelo para que en lugar de una pelotita, se muestren 
#simultáneamente varias pelotitas (cinco, por ejemplo), cada una con su posición,
